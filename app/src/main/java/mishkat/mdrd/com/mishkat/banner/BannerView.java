package mishkat.mdrd.com.mishkat.banner;
...
public class BannerView extends RelativeLayout {
    private static final int DEFAULT_INTERVAL_TIME = 2 * 1000;

    private static final int titleBackgroundColor = Color.parseColor("#00000000");
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        //Initialize the viewpager and indicator layout and add to the parent layout
       ...
       // mBottomLayout.addView(mTextView);
        ...
        mIndicatorLayout.setPadding(0, 100, 0, 0);
    ...
    public synchronized void setBannerItems(List<BannerItem> items) {
        ...
        //Automatically rotate only when it is larger than one carousel
    ...
    private void generateIndicators(List<BannerItem> mBannerItems, LinearLayout mIndicatorLayout) {
        ...
        for (int i = 0; i < bannerCount; i++) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(dip2px(mContext, 10), dip2px(mContext, 10));
            layoutParams.setMargins(dip2px(mContext, 7), 0, dip2px(mContext, 7), 0);
    ...
    //
    //Refresh indicator display position
    ...
    //Get the location of the next banner to display
