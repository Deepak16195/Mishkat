...
public class ItemDetilsviewpage extends PagerAdapter {
    private Context context;
    private List<Singer> singers;

    public ItemDetilsviewpage(Context context, List<Singer> singers) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = LayoutInflater.from(context).inflate(R.layout.itemdetils, container, false);
