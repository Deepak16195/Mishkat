...
public class ChackoutListAdapter extends RecyclerView.Adapter<ChackoutListAdapter.HorizontalViewHolder> {


    @Override
    public HorizontalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.chackout_list_item, parent, false);
